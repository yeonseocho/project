...
public class DetailController {
	...
	@PostMapping("/add")
	@ResponseBody
	public String save(@RequestParam("files") MultipartFile[] mfiles, HttpServletRequest request, DetailVO detail) {
		boolean saved = svc.addDetail(request, detail, mfiles);
		return "saved = " + saved;
	}

	@GetMapping("/list")
	public String detailList(Model model) {
		model.addAttribute("list", svc.detailList());
		return "detail/list";
	}

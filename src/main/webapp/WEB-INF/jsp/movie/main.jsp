...
<link
	href="https://fonts.googleapis.com/css2?family=Black+Han+Sans&family=Do+Hyeon&family=Gowun+Dodum&family=Rowdies:wght@300;400;700&display=swap"
	rel="stylesheet">
<style>
div>h2 {
	text-align: center;
	...
	<nav class="navbar navbar-expand-lg navbar-light">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="/moveMain.do">박스
						오피스 순위</a></li>

				<li class="nav-item"><a class="nav-link" href="/moveReserve.do">예매하기</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="/mb/login">로그인</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="/mb/add">회원가입</a>
				</li>

			</ul>
		</div>
	</nav>
	<div id="carouselExampleControls" class="carousel slide carousel-img"
		data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="/img/main3.png" class="d-block main-img" alt="..."
					style="width: 100%">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=2"> <img src="/img/frozen.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
				...
				<div class="col-1" style="max-width: 3.333333%;"></div>
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=8"> <img src="/img/once.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
						<div class="card-body">
				...
				<div class="col-1" style="max-width: 3.333333%;"></div>
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=9"> <img src="/img/parasite.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
						<div class="card-body">
				...
				<div class="col-1" style="max-width: 3.333333%;"></div>
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=10"> <img src="/img/spider.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
						<div class="card-body">
				...
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=12"> <img src="/img/ani.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
						<div class="card-body">
							<h2>신비한 동물사전</h2>
				...
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=13"> <img src="/img/ani2.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
						<div class="card-body">
				...
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=14"> <img src="/img/dune.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
				...
				<div class="col-1" style="max-width: 3.333333%;"></div>
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=15 "> <img src="/img/cruella.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
				...
				<div class="col-1" style="max-width: 3.333333%;"></div>
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=16"> <img src="/img/batman.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
						<div class="card-body">
				...
				<div class="col-1" style="max-width: 3.333333%;"></div>
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=17"> <img src="/img/secret.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
						<div class="card-body">
				...
				<div class="col-1" style="max-width: 3.333333%;"></div>
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=18"> <img src="/img/now.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
						<div class="card-body">
				...
				<div class="col-1" style="max-width: 3.333333%;"></div>
				<div class="card" style="width: 15rem;">
					<a href="/de/detail?num=19"> <img src="/img/chung.JPG"
						class="card-img-top card-img" name="poster" alt="imgUrl"
						width="100%" height="340px">
						<div class="card-body">
